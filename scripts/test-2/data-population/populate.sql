...
INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(2, 'Broken Souls', 195, 1, 'https://somecdn.com', false, false, "MHeart Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(3, 'Broken Tears', 241, 1, 'https://somecdn.com', false, false, "MHeart Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(4, 'Hope', 251, 1, 'https://somecdn.com', true, false, "MHeart Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(5, 'After the storm', 260, 1, 'https://somecdn.com', false, false, "MHeart Records", now());
...
INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(2, 'Productivity Routines', 1, false, 3700, 'Let us assess the best daily routines', true, 1, 2, now());

INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(3, 'Successful people routines', 1, false, 3800, 'Peeking into successful routines', true, 1, 3, now());
...
INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(7, 'Walking in the desert', 285, 2, 'https://somecdn.com', true, false, "Alternative Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(8, 'Look at the stars', 280, 2, 'https://somecdn.com', true, false, "Alternative Records", now());
...
INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(5, 'What is indie music?', 2, false, 3660, 'What the heck is indie music?', true, 1, 2, now());

INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(6, 'Alternative Eroticism', 2, false, 3700, 'How to love alternatively?', false, 1, 3, now());
...
INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(10, 'Arkansas evenings', 230, 3, 'https://somecdn.com', false, false, "American Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(11, 'Nights in Las Vegas', 220, 3, 'https://somecdn.com', false, false, "American Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(12, 'Yesterday I saw an eagle', 365, 3, 'https://somecdn.com', false, false, "American Records", now());
...
INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(8, 'Marriage problems', 3, false, 3660, 'Some common marriage problems', false, 1, 2, now());

INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(9, 'Did you marriage the wrong person?', 3, false, 4000, 'How to know if I did not make a mistake?', false, 1, 3, now());

INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(10, 'First episode of second season!', 3, true, 1880, 'Second season inauguration!', true, 2, 1, now());

INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(11, 'What to do when children act out?', 3, false, 3677, 'Some tips to take control over your naughty children', false, 2, 2, now());

INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(12, 'I cheated on my spouse', 3, false, 3677, 'What to do if you cheated ...', false, 2, 3, now());
...
INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(14, 'Death and Chaos', 290, 4, 'https://somecdn.com', false, false, "Nashville Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(15, 'Detachment', 300, 4, 'https://somecdn.com', false, false, "Nashville Records", now());

INSERT INTO musical_piece
(id, title, duration, album_id, cover_image_link, is_child_friendly, is_free, rights_owner, created_at)
VALUES(16, 'Works of destiny', 450, 4, 'https://somecdn.com', true, false, "Nashville Records", now());
...
INSERT INTO podcast_episode
(id, title, show_id, is_free, duration, description, is_child_friendly, season_number, episode_number, created_at)
VALUES(14, 'Books that I read', 4, false, 3630, 'I will let you know my books', true, 1, 2, now());
...
INSERT INTO user
(id, name, email, nickname, country, city, preferred_language, payment_method, is_premium, birthdate, created_at)
VALUES(2, 'Mordecai Smith', 'morsmith@gmail.com', 'morsmith', 'united states of america', 'new york', 'english', 'CreditCard', true, '2000-04-03', now());

-- User 3
INSERT INTO user
(id, name, email, nickname, country, city, preferred_language, payment_method, is_premium, birthdate, created_at)
VALUES(3, 'Toni Abasi', 'tonasi@gmail.com', 'tonasi', 'united states of america', 'nashville', 'english', 'CreditCard', true, '1999-04-03', now());

-- User 4
INSERT INTO user
(id, name, email, nickname, country, city, preferred_language, payment_method, is_premium, birthdate, created_at)
VALUES(4, 'Sean Mendez', 'seamen@gmail.com', 'seamen', 'united kingdom', 'london', 'english', 'DebitCard', false, '2001-02-03', now());

-- User 5
INSERT INTO user
(id, name, email, nickname, country, city, preferred_language, payment_method, is_premium, birthdate, created_at)
VALUES(5, 'Marie Courtier', 'macour@gmail.com', 'macour', 'united states of america', 'compton city', 'english', 'DebitCard', false, '1998-02-03', now());

-- User 6
INSERT INTO user
(id, name, email, nickname, country, city, preferred_language, payment_method, is_premium, birthdate, created_at)
VALUES(6, 'Claudia Courier', 'clacour@gmail.com', 'clacour', 'united united kingdom', 'oxford', 'english', 'CreditCard', false, '1999-03-03', now());
...
INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(4, 5, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(4, 6, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(4, 11, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(4, 12, false, now());
...
INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(5, 7, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(5, 8, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(5, 9, false, now());
...
INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(6, 2, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(6, 3, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(6, 10, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(6, 11, false, now());

INSERT INTO music_like
(user_id, musical_piece_id, is_unliked, created_at)
VALUES(6, 12, false, now());
...
INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(2, 8, false, now());

INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(2, 9, false, now());
...
INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(3, 5, false, now());

INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(3, 6, false, now());

INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(3, 7, false, now());
...
INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(5, 2, false, now());

INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(5, 12, false, now());

INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(5, 13, false, now());

INSERT INTO podcast_like
(user_id, podcast_episode_id, is_unliked, created_at)
VALUES(5, 14, false, now());
...
INSERT INTO featuring_artist
(id, name, musical_piece_id, created_at)
VALUES(6, "Pamela Hurtado", 10, now());
...
INSERT INTO featuring_artist
(id, name, musical_piece_id, created_at)
VALUES(8, "Ramon Diaz", 11, now());

INSERT INTO featuring_artist
(id, name, musical_piece_id, created_at)
VALUES(9, "Selena Gomez", 11, now());
...
INSERT INTO participant
(id, name, podcast_episode_id, created_at)
VALUES(5, "Jordan Peterson", 5, now());
...
INSERT INTO participant
(id, name, podcast_episode_id, created_at)
VALUES(7, "Mikaila Peterson", 6, now());
...
INSERT INTO participant
(id, name, podcast_episode_id, created_at)
VALUES(11, "Pewdie Pie", 10, now());

INSERT INTO participant
(id, name, podcast_episode_id, created_at)
VALUES(12, "Steve Terreberry", 10, now());
